...
- **Contact info wired in** — phone `+91 97897 46505` and email `rockmadhuvarma23@gmail.com` now appear in the footer (every page), the enroll page, and the "prefer to call?" line under both lead forms.
